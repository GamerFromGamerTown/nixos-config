...
boot = {
    ...
    kernelModules = [ "acct" "kvm-intel" "usbhid" "hid_generic" "e100e" "xhci_pci" "ehci_pci" "vfat" "ntfs" "btrfs" "iwlwifi" "bridge" "apparmor" "coretemp"];  # Replace with the actual module names
