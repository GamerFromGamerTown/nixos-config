...
apparmor-profiles auto-cpufreq bc binutils bison brightnessctl btop bubblewrap busybox catppuccin catppuccin-cursors (catppuccin-gtk.override {
    ...
    variant = "macchiato";
  })  catppuccin-kde catppuccin-papirus-folders clamav cmake dash flex gcc git gnome.file-roller gnumake gsettings-desktop-schemas home-manager htop hyprpaper inconsolata kdenlive kitty plasma-desktop playonlinux libglvnd libnotify logrotate lynis nordic mesa mesa.drivers macchanger opensnitch opensnitch-ui pavucontrol pipewire pkg-config polkit polkit_gnome python3 qemu rsync sddm sddm-chili-theme shattered-pixel-dungeon speechd swaybg swaylock tcpcrypt thunderbird tldr undervolt unzip wine wineWowPackages.full virt-manager waybar wget wofi zsh
];
